...
export default defineConfig({
  ...
  plugins: [
    ...
    }),
    {
      ...
      async transformIndexHtml (html) {
        ...
        return microTemplate(html, { SITE_PATH: '', UI_CONFIG_PATH: uiConfigPath, THEME_CSS_HASH: '', PUBLIC_SITE_INFO_HASH: '', PRELOAD_LINKS: '', CSP_NONCE: '' })
      }
    }
  ],
  experimental: {
  ...
  server: { hmr: { port: parseInt(process.env.DEV_UI_HMR_PORT!) } }
})
