    ...
    <v-container :fluid="page.width === 'full'">
      <template v-if="pageConfig">
        ...
        <v-hover
          ...
          v-slot="{ hover }"
        >
          <div :style="(hover && page.config.title ? 'background-color:#BBBBBB;' : '') + 'position:relative'">
            <v-btn
              v-show="hover"
              color="primary"
              fab
      ...
      <template v-if="pageConfig">
        ...
        <v-hover
          ...
          v-slot="{ hover }"
        >
          <div :style="(hover && page.config.description ? 'background-color:#BBBBBB;' : '') + 'position:relative'">
            <v-btn
              v-show="hover"
              color="primary"
              fab
      ...
      />
      <events-register
        v-if="!config.eventsHideSubscribe && !pageConfig && page.config.datetimes && page.config.datetimes.end && page.config.datetimes.end > new Date().toISOString()"
        :page-id="page.id"
      ...
      <template v-if="pageConfig">
        ...
        <v-hover
          ...
          v-slot="{ hover }"
        >
          <div :style="(hover && page.config.datetimes ? 'background-color:#BBBBBB;' : '') + 'position:relative;display:inline-block'">
            <v-btn
              v-show="hover"
              color="primary"
              fab
      ...
      <template v-if="pageConfig">
        ...
        <v-hover
          ...
          v-slot="{ hover }"
        >
          <div :style="(hover && page.config.location ? 'background-color:#BBBBBB;' : '') + 'position:relative;display:inline-block'">
            <v-btn
              v-show="hover"
              color="primary"
              fab
      ...
      >
        <template v-if="pageConfig">
          ...
          <v-hover
            ...
            v-slot="{ hover }"
          >
            <div :style="(hover ? 'background-color:#BBBBBB;' : '') + 'position:relative'">
              <v-btn
                v-show="hover"
                :key="'b' + i"
                color="primary"
