      ...
      >
        <div :style="`width:190px;height:0;position:fixed;${page.config.toc && page.config.toc.display === 'right' ? 'right:32px' : ''}`">
          <v-btn
            ...
            fab
            absolute
            :style="`right:${savedConfig.toc ? 16 : -16}px;margin-top:-16px`"
            x-small
          ...
          <v-btn
            v-if="savedConfig.toc"
            v-show="hover"
            color="warning"
            fab
            absolute
            :style="`right:-16px;margin-top:-16px`"
            x-small
          ...
          <layout-toc
            ...
            :style="`${page.config.toc.display}:16px;`"
    ...
    <v-container :fluid="page.width === 'full'">
      ...
      >
        <template v-if="pageConfig">
          ...
          >
            <div
              :style="(hover ? 'background-color:#BBBBBB;' : '') + 'position:relative;min-height:24px'"
            >
              <v-btn
                v-show="hover"
                :key="'b' + i"
