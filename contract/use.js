...
module.exports = {
  ...
  properties: {
    ...
    datasets: {
      ...
      'x-fromUrl': '{context.dataFairUrl}/api/v1/datasets?q={q}&publicationSites={context.publicationSite}&visibility=public&size=1000&select=id,slug,title&sort=createdAt:-1',
      'x-itemsProp': 'results',
      'x-itemTitle': 'title',
      'x-itemKey': 'href',
      items: {
