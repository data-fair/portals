...
export default {
  ...
  layout: {
    ...
    children: [
      ...
      { title: 'Réutilisations', children: ['uses'] },
  ...
  required: ['title', 'authentication', 'theme', 'header', 'navBar', 'menu', 'breadcrumb', 'footer', 'datasets', 'applications', 'uses', 'contactInformations', 'socialShares', 'socialLinks', 'personal'],
  properties: {
    title: {
      type: 'string',
      title: 'Titre'
    ...
    uses: { $ref: 'https://github.com/data-fair/portals/portal-config-uses' },
