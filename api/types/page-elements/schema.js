  ...
  $defs: {
    element: {
      ...
      oneOf: [
        ...
        { $ref: 'https://github.com/data-fair/portals/page-element-basics#/$defs/element-text' },
        ...
        { $ref: 'https://github.com/data-fair/portals/page-element-navigation#/$defs/element-menu' },
        { $ref: 'https://github.com/data-fair/portals/page-element-navigation#/$defs/element-breadcrumbs' },

        // Layout & structure
        { $ref: 'https://github.com/data-fair/portals/page-element-layout#/$defs/element-divider' },
        { $ref: 'https://github.com/data-fair/portals/page-element-layout#/$defs/element-banner' },
        { $ref: 'https://github.com/data-fair/portals/page-element-layout#/$defs/element-card' },
        { $ref: 'https://github.com/data-fair/portals/page-element-layout#/$defs/element-two-columns' },
        { $ref: 'https://github.com/data-fair/portals/page-element-layout#/$defs/element-responsive-grid' },
        { $ref: 'https://github.com/data-fair/portals/page-element-layout#/$defs/element-tabs' },
        { $ref: 'https://github.com/data-fair/portals/page-element-layout#/$defs/element-expansion-panels' },

        // Functional blocks
        { $ref: 'https://github.com/data-fair/portals/page-element-functional#/$defs/element-search' },
        { $ref: 'https://github.com/data-fair/portals/page-element-functional#/$defs/element-topics' },
        { $ref: 'https://github.com/data-fair/portals/page-element-functional#/$defs/element-metrics' },
        { $ref: 'https://github.com/data-fair/portals/page-element-functional#/$defs/element-contact' },

        // Datasets
        { $ref: 'https://github.com/data-fair/portals/page-element-datasets#/$defs/element-datasets-catalog' },
        { $ref: 'https://github.com/data-fair/portals/page-element-datasets#/$defs/element-datasets-list' },
        { $ref: 'https://github.com/data-fair/portals/page-element-datasets#/$defs/element-dataset-card' },
        { $ref: 'https://github.com/data-fair/portals/page-element-datasets#/$defs/element-dataset-table' },
        { $ref: 'https://github.com/data-fair/portals/page-element-datasets#/$defs/element-dataset-form' },
        { $ref: 'https://github.com/data-fair/portals/page-element-datasets#/$defs/element-dataset-download' },

        // Applications
        { $ref: 'https://github.com/data-fair/portals/page-element-applications#/$defs/element-applications-catalog' },
        { $ref: 'https://github.com/data-fair/portals/page-element-applications#/$defs/element-applications-list' },
        { $ref: 'https://github.com/data-fair/portals/page-element-applications#/$defs/element-application' },

        // Reuses
        { $ref: 'https://github.com/data-fair/portals/page-element-reuses#/$defs/element-reuses-catalog' },
        { $ref: 'https://github.com/data-fair/portals/page-element-reuses#/$defs/element-reuses-list' },
        { $ref: 'https://github.com/data-fair/portals/page-element-reuses#/$defs/element-reuse-card' },

        // Events
        { $ref: 'https://github.com/data-fair/portals/page-element-events#/$defs/element-event-catalog' },
        { $ref: 'https://github.com/data-fair/portals/page-element-events#/$defs/element-event-list' },
        { $ref: 'https://github.com/data-fair/portals/page-element-events#/$defs/element-event-card' },

        // News
        { $ref: 'https://github.com/data-fair/portals/page-element-news#/$defs/element-news-catalog' },
        { $ref: 'https://github.com/data-fair/portals/page-element-news#/$defs/element-news-list' },
        { $ref: 'https://github.com/data-fair/portals/page-element-news#/$defs/element-news-card' },

        // Functional (appended last to keep existing discriminator indices stable)
