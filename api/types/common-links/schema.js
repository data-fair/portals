...
export default {
  ...
  $defs: {
    linkItem: {
      ...
      oneOf: [
        structuredClone(standardPage),
        structuredClone(genericPage),
        structuredClone(eventPage),
        structuredClone(newsPage),
        structuredClone(externalLink)
      ]
    },
