<template>
  ...
  >
    <path
      ...
      transform="translate(-26.97 -40.04)" :fill="colors.primary" opacity="0.1" />
    <ellipse cx="120.3" cy="728.81" rx="88.28" ry="14.18" :fill="colors.primary" opacity="0.1" />
    <ellipse cx="912.26" cy="804.71" rx="156.53" ry="15.2" :fill="colors.primary" opacity="0.1" />
    <rect x="117.65" y="115.32" width="947.42" height="528.97" rx="12.49" ry="12.49" :fill="colors.surface" />
    <rect x="117.65" y="115.32" width="947.42" height="528.97" rx="12.49" ry="12.49" :fill="colors.surface" />
    <rect
      x="117.65" y="115.32" width="947.42" height="528.97" rx="12.49" ry="12.49" :fill="colors.surface"
      opacity="0.04"
    />
    <path
      d="M1087.23,149.29H149.43a4.81,4.81,0,0,0-4.81,4.81v20.33H1092V154.1A4.81,4.81,0,0,0,1087.23,149.29Z"
      transform="translate(-26.97 -40.04)" :fill="colors['surface-inverse']" />
    <g data-name="buttons">
      <circle cx="136.57" cy="121.82" r="6.5" :fill="colors.surface" />
      <circle cx="154.07" cy="121.82" r="6.5" :fill="colors.surface" />
      <circle cx="171.57" cy="121.82" r="6.5" :fill="colors.surface" />
    </g>
    <rect x="195.68" y="181.67" width="254.25" height="21.58" :fill="colors.primary" opacity="0.2" />
    <rect x="195.68" y="268.2" width="791.36" height="331.96" :fill="colors['surface-inverse']" opacity="0.1" />
    <path
    ...
    <path
      ...
      transform="translate(-26.97 -40.04)" :fill="colors.primary" />
    <rect x="906.94" y="236.25" width="80.1" height="18.91" :fill="colors['surface-inverse']" opacity="0.1" />
    <path
      ...
      transform="translate(-26.97 -40.04)" :fill="BODY_COLOR" />
    <path
    ...
    <path
      ...
      transform="translate(-26.97 -40.04)" opacity="0.1" />
    <path
      d="M1004.63,524l.44,16.75-4.82,4.37L997,504.57h7.2Z" transform="translate(-26.97 -40.04)"
      opacity="0.1" />
    <path
    ...
    <path
      ...
      transform="translate(-26.97 -40.04)" :fill="colors['surface-inverse']" />
    <circle cx="924.25" cy="469.12" r="4.59" :fill="colors['surface-inverse']" />
    <circle cx="924.25" cy="490.76" r="4.59" :fill="colors['surface-inverse']" />
    ...
    <path
      ...
      transform="translate(-26.97 -40.04)" :fill="colors.primary" />
    <rect x="117.46" y="457.19" width="5.68" height="127.9" :fill="colors['surface-inverse']" />
    <path
    ...
    <path
      ...
      transform="translate(-26.97 -40.04)" fill="none" :stroke="colors['on-primary']" stroke-miterlimit="10"
      stroke-width="2" />
    <path
